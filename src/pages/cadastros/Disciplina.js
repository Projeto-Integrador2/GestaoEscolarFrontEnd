...
import {DisciplinaService} from "../../service/cadastros/DisciplinaService";
...
const Disciplina = () => {
    ...
    const objetoService = new DisciplinaService();
    ...
    const leftToolbarTemplate = () => {
        return (
            <React.Fragment>
                <div className="my-2">
                    <Button label="Novo Disciplina" icon="pi pi-plus" className="p-button-success mr-2" onClick={openNew}/>
    ...
    const objetoDialogFooter = (
        <>
            ...
            <Button type="submit" form="formularioDisciplina" label="Salvar" icon="pi pi-check" className="p-button-text"/>
        </>
    );
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <Dialog visible={objetoDialog} style={{width: '450px'}} header="Cadastrar/Editar" modal className="p-fluid" footer={objetoDialogFooter} onHide={hideDialog}>
                        <form id="formularioDisciplina" onSubmit={formik.handleSubmit}>
                            <div className="field">
...
export default React.memo(Disciplina, comparisonFn);
